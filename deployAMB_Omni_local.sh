...
FOREIGN_AMB_IMPLMENTATION=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY tokenbridge-contracts/contracts/upgradeable_contracts/arbitrary_message/ForeignAMB.sol:ForeignAMB --json)
...
FOREIGN_AMB_UPGRADE_TX=$(cast send $FOREIGN_AMB_PROXY_ADDRESS "upgradeTo(uint256, address)" 1 $FOREIGN_AMB_IMPLEMENTATION_ADDRESS  --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY --json)
...
HOME_AMB_PROXY=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY tokenbridge-contracts/contracts/upgradeability/EternalStorageProxy.sol:EternalStorageProxy --json)
HOME_AMB_PROXY_ADDRESS=$(jq -r '.deployedTo' <<< "$HOME_AMB_PROXY")
echo "HOME AMB Proxy deployed to " $HOME_AMB_PROXY_ADDRESS

HOME_AMB_IMPLMENTATION=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY tokenbridge-contracts/contracts/upgradeable_contracts/arbitrary_message/ForeignAMB.sol:ForeignAMB --json)
...
HOME_AMB_UPGRADE_TX=$(cast send $HOME_AMB_PROXY_ADDRESS "upgradeTo(uint256, address)" 1 $HOME_AMB_IMPLEMENTATION_ADDRESS  --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY --json)
HOME_UPGRADE_TX_HASH=$(jq -r '.transactionHash' <<< "$HOME_AMB_UPGRADE_TX")
echo "Binding proxy and implementation " $HOME_UPGRADE_TX_HASH

HOME_INITIALIZE_TX=$(cast send  $HOME_AMB_PROXY_ADDRESS "initialize(uint256,uint256,address,uint256,uint256,uint256,address)" $HOME_CHAIN_ID $FOREIGN_CHAIN_ID $HOME_VALIDATOR_PROXY_ADDRESS $MAX_GAS_PER_TX $GAS_PRICE $REQUIRED_BLOCK_CONFIRMATION $OWNER_ADDR --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY --json)
HOME_INITIALIZE_TX_HASH=$(jq -r '.transactionHash' <<< "$HOME_INITIALIZE_TX")
echo "HOME AMB initialized " $HOME_INITIALIZE_TX_HASH

HOME_AMB_HELPER=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY tokenbridge-contracts/contracts/helpers/AMBBridgeHelper.sol:AMBBridgeHelper --constructor-args $HOME_AMB_PROXY_ADDRESS --json)
...
FOREIGN_OMNIBRIDGE_PROXY=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY tokenbridge-contracts/contracts/upgradeability/EternalStorageProxy.sol:EternalStorageProxy --json)
...
FOREIGN_OMNIBRIDGE_IMPLEMENTATION=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY omnibridge/contracts/upgradeable_contracts/ForeignOmnibridge.sol:ForeignOmnibridge --constructor-args $FOREIGN_PREFIX --json)
...
FOREIGN_OMNIBRIDGE_UPGRADE_TX=$(cast send $FOREIGN_OMNIBRIDGE_PROXY_ADDRESS "upgradeTo(uint256, address)" 1 $FOREIGN_OMNIBRIDGE_IMPLEMENTATION_ADDRESS  --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY --json)
...
FOREIGN_PERMITTABLE_TOKEN=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY omnibridge/precompiled/PermittableToken_flat.sol:PermittableToken  --constructor-args " " " " 18 $FOREIGN_CHAIN_ID --json)
...
FOREIGN_TOKEN_FACTORY=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY omnibridge/contracts/upgradeable_contracts/modules/factory/TokenFactory.sol:TokenFactory --constructor-args $OWNER_ADDR $FOREIGN_PERMITTABLE_TOKEN_ADDRESS --json)
...
FOREIGN_FORWARDING_RULE=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY omnibridge/contracts/upgradeable_contracts/modules/forwarding_rules/MultiTokenForwardingRulesManager.sol:MultiTokenForwardingRulesManager --constructor-args $OWNER_ADDR --json)
...
FOREIGN_SELECTOR_GAS_LIMIT=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY omnibridge/contracts/upgradeable_contracts/modules/gas_limit/SelectorTokenGasLimitManager.sol:SelectorTokenGasLimitManager --constructor-args $FOREIGN_AMB_PROXY_ADDRESS $OWNER_ADDR $FOREIGN_REQUEST_GAS_LIMIT --json)
...
HOME_OMNIBRIDGE_PROXY=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY tokenbridge-contracts/contracts/upgradeability/EternalStorageProxy.sol:EternalStorageProxy --json)
...
HOME_OMNIBRIDGE_IMPLEMENTATION=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY omnibridge/contracts/upgradeable_contracts/HomeOmnibridge.sol:HomeOmnibridge --constructor-args $HOME_PREFIX --json)
...
HOME_OMNIBRIDGE_UPGRADE_TX=$(cast send $HOME_OMNIBRIDGE_PROXY_ADDRESS "upgradeTo(uint256, address)" 1 $HOME_OMNIBRIDGE_IMPLEMENTATION_ADDRESS  --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY --json)
...
HOME_PERMITTABLE_TOKEN=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY omnibridge/precompiled/PermittableToken_flat.sol:PermittableToken --constructor-args " " " " 18 $HOME_CHAIN_ID --json)
...
HOME_TOKEN_FACTORY=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY omnibridge/contracts/upgradeable_contracts/modules/factory/TokenFactory.sol:TokenFactory --constructor-args $OWNER_ADDR $HOME_PERMITTABLE_TOKEN_ADDRESS --json)
...
HOME_FORWARDING_RULE=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY omnibridge/contracts/upgradeable_contracts/modules/forwarding_rules/MultiTokenForwardingRulesManager.sol:MultiTokenForwardingRulesManager --constructor-args $OWNER_ADDR --json)
...
HOME_SELECTOR_GAS_LIMIT=$(forge create --rpc-url $LOCAL_RPC_URL --private-key $ANVIL_PRIV_KEY omnibridge/contracts/upgradeable_contracts/modules/gas_limit/SelectorTokenGasLimitManager.sol:SelectorTokenGasLimitManager --constructor-args $HOME_AMB_PROXY_ADDRESS $OWNER_ADDR $HOME_REQUEST_GAS_LIMIT --json)
